...
public class EnrollmentPanel extends VBox {
    ...
    // Constructor initializes the enrollment panel
    public EnrollmentPanel(ObservableList<Student> students, Map<String, ArrayList<String>> enrollments, StudentPanel studentPanel) {
        ...
        getChildren().addAll(new Label("Course Enrollment"), form);
    }
